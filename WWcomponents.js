...
<section class="box-chat">
        <div class="left">
            ...
            <div class="inf-user">
                <div class="menu">
                    ...
                    <a class="commingSoon" href="#"><i class="far fa-address-card"></i> Thông tin cơ bản
                    <span class="tooltiptext">Comming soon ^^</span>
                    </a>
                </div>
                <div class="menu">

                    <a class="commingSoon" href="#"><i class="fa fa-gift fa-fw" aria-hidden="true"></i> Quà tặng
                    <span class="tooltiptext">Comming soon ^^</span>
                    </a>
                ...
                <div class="menu">
                    ...
                    <a class="commingSoon" href="#"> <i class="fa fa-cogs fa-fw" aria-hidden="true"></i> Cài đặt
                    <span class="tooltiptext">Comming soon ^^</span>
                    </a>
                ...
                <div class="menu">
                    ...
                    <a class="commingSoon" href="#"><i class="fas fa-hands-helping"></i> Hỗ trợ
                    <span class="tooltiptext">Comming soon ^^</span>
                    </a>
        ...
        <div class="right">
            ...
            <div class="btn-inf">
                <button  type="submit" id="vote" class="Vote">Vote</button>
                <button id="effect" class="effect">Chức năng</button>
